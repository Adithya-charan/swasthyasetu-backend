...
INSERT IGNORE INTO users (id, full_name, email, password_hash, role, phone, is_active, created_at, updated_at)
VALUES 
...
INSERT IGNORE INTO doctor_profiles (id, specialization, qualifications, experience_years, license_number, consultation_fee, bio)
VALUES 
